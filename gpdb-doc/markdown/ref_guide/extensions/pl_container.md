...
![PL/Container architecture diagram](../graphics/pl_container_architecture.png)
...
-   PL/Container logging is activated or deactivated for each runtime ID with the `setting` attribute `use_container_logging`. The default is no logging.
