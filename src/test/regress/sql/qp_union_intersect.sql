...
-- test INTERSECT/EXCEPT with Entry and Partitioned locus
explain (costs off)
select relnatts from pg_class intersect select * from p1;
explain (costs off)
select relnatts from pg_class except select * from p1;
